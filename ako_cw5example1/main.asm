...
_main proc
	finit
	fld		wsp_a							; zaladowanie wspolczynnika a
	fld		wsp_b							; zaladowanie wspolczynnika b
	...
	; rozkaz FCOMI - oba porownywane operandy musza byc podane na
	; stosie koprocesora
	fcomi	st(0), st(1)
	; usuniecie zera z wierzcholka stosu
	fstp	st(0)
	ja		delta_ujemna					; skok, gdy delta ujemna
	; w przykladzie nie wyodrebnia sie przypadku delta = 0
	; sytuacja na stosie: ST(0) = b^2 - 4 * a * c, ST(1) = a,
	; ST(2) = b
	...
	; przechowanie obliczonej wartosci
	fst		st(3)
	...
	fstp	x1								; zapisanie x1 w pamieci
